unit Terasoft.Framework.SSHTunnel;
{
...
Uses
  System.SysUtils,
  Terasoft.Framework.SSH2Session;
...
type
  ...
  ISshTunnel = interface
    ...
    procedure ForwardLocalPort(const LocalPort: Word; const RemoteHost: string;
      const RemotePort: Word; pContext: String = '');
...
Uses
  ...
  Winapi.Winsock2,
  Terasoft.Framework.SocketUtils;
...
procedure TSshTunnel.ForwardLocalPort;
{
...
begin
  ...
  ListenSock := GetWinSock.CreateSocketAndListen(pContext, LocalPort);
