    ...
    begin
      ...
      begin
        ...
        if lPixModel.objeto.TotalRecords = 0 then
          CriaException('Pix n�o recebido. Realizar o recebimento');
      end;
    end;
...
begin
  ...
  if (self.FCODIGO_CLI = '000000') and (pPortador = '000001') then
    CriaException('Para o cliente consumidor o portador n�o pode ser carteira.');

  if (self.FCODIGO_CLI = '000000') and (pPortador = '000005') then
    CriaException('Para o cliente consumidor o portador n�o pode ser boleto.');

  if (self.FCODIGO_CLI = '000000') and (pPortador = '000003' ) then
    CriaException('Para o cliente consumidor o portador n�o pode ser cheque.');
  ...
  try
    ...
    begin
      ...
      if lClienteModel.objeto.seprocado_cli <> 'N' then
        CriaException('Cliente n�o est� liberado para venda com este portador.');
...
begin
  ...
  try
    if pVenderItem.Quantidade = 0 then
      CriaException('Quantidade inv�lida.');
