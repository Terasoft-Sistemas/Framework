...
begin
  ...
  try
    case FAcao of
      Terasoft.Enumerado.tacIncluir: Result := lCaixaDao.incluir(Self);
      Terasoft.Enumerado.tacAlterar: Result := lCaixaDao.alterar(Self);
      Terasoft.Enumerado.tacExcluir: Result := lCaixaDao.excluir(Self);
    end;
