...
function TTransportadoraDao.ObterLista: TFDMemTable;
var
  lQry       : TFDQuery;
  lSQL       : String;
  lPaginacao : String;
  ...
  try
    ...
    begin
      ...
      if Assigned(lProp) then
        ...
        Unassigned, vConstrutor.getValue(lTabela, pQry.Params[i].Name, lProp.GetValue(pTransportadoraModel).AsString))
    end;
  finally
    lCtx.Free;
  end;
