...
type
  ...
  public
    ...
    function incluir(AClienteModel: TClienteModel): String;
    function alterar(AClienteModel: TClienteModel): String;
    function excluir(AClienteModel: TClienteModel): String;
...
function TClienteDao.incluir(AClienteModel: TClienteModel): String;
var
  lQry: TFDQuery;
  lSQL:String;
begin
...
function TClienteDao.alterar(AClienteModel: TClienteModel): String;
var
  lQry: TFDQuery;
  lSQL:String;
begin
...
function TClienteDao.excluir(AClienteModel: TClienteModel): String;
var
  lQry: TFDQuery;
begin
  lQry := vIConexao.CriarQuery;
  try
   ...
   lQry.ExecSQL;
   Result := AClienteModel.ID;
  finally
    lQry.Free;
  end;
end;

function TClienteDao.montaCondicaoQuery: String;
var
  lSQL : String;
begin
  lSQL := '';
