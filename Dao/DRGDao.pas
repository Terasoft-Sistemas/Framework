    ...
    begin
      ...
      begin
        lMemTable.objeto.InsertRecord([
                                ...
                                lQry.FieldByName('CONTA').AsString,
                                lQry.FieldByName('SUBGRUPO').AsString,
  ...
  try
    ...
    begin
      ...
      if pDRG_Parametros.ValorPrincipal = 0 then
        pDRG_Parametros.ValorPrincipal := lQry.FieldByName('Valor').AsFloat;
      ...
      begin
        case pDRG_Parametros.NivelVisualizacao of
          tpNivel1 :
            begin
              lGrupo    := lQry.FieldByName('GRUPO').AsString;
              lSubGrupo := '';
              lConta    := '';
            end;
          ...
          tpNivel2 :
            begin
              lGrupo    := lQry.FieldByName('GRUPO').AsString;
              lSubGrupo := lQry.FieldByName('SUBGRUPO').AsString;
              lConta    := '';
            end;
          ...
          tpNivel3 :
            begin
              lGrupo    := lQry.FieldByName('GRUPO').AsString;
              lSubGrupo := lQry.FieldByName('SUBGRUPO').AsString;
              lConta    := lQry.FieldByName('CONTA').AsString;
            end;
        ...
        begin
          lMemTable.InsertRecord([
                                  ...
                                  lConta,
                                  lQry.FieldByName('VALOR').AsFloat,
                                  lQry.FieldByName('VALOR').AsFloat / pDRG_Parametros.ValorPrincipal * 100
                                ]);
        end else
        begin
          lMemTable.Edit;
          lMemTable.FieldByName('VALOR').AsFloat       := lMemTable.FieldByName('VALOR').AsFloat + lQry.FieldByName('VALOR').AsFloat;
