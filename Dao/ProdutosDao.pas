...
type
  ...
  public
    ...
    function incluir(AProdutosModel: TProdutosModel): String;
    function alterar(AProdutosModel: TProdutosModel): String;
    function excluir(AProdutosModel: TProdutosModel): String;
...
function TProdutosDao.incluir(AProdutosModel: TProdutosModel): String;
var
  lQry: TFDQuery;
  lSQL:String;
begin
...
function TProdutosDao.alterar(AProdutosModel: TProdutosModel): String;
var
  lQry: TFDQuery;
  lSQL:String;
begin
...
function TProdutosDao.excluir(AProdutosModel: TProdutosModel): String;
var
  lQry: TFDQuery;
begin
  lQry := xConexao.CriarQuery;
...
function TProdutosDao.montaCondicaoQuery: String;
var
  lSQL : String;
begin
  lSQL := '';
